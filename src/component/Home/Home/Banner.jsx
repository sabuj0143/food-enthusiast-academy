...
const Banner = () => {
    return (
        <div className='w-full h-[90vh] bg-[#0F172A] text-white border border-[#612953] p-8 mb-8 my-4'>
            <div className="banner-container md:flex items-center justify-around p-2">
                <div data-aos="fade-right"
                    ...
                    <h4 className='text-center lilita font-semibold text-4xl'>Welcome To <span className='text-blue-800'>Food Enthusiast-Academy</span></h4>
                    ...
                    <div>
                        <button className="btn btn-warning text-white font-semibold mt-6 w-[50%]"><span className='space-x-4'>Contact us</span> <span className='ml-2'></span></button>
                    </div>
                </div>
